...
public class adminController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        if(loginSuccess=="true" && usr!= null && userType == "admin") {
            ...
            getServletConfig().getServletContext().getRequestDispatcher("/WEB-INF/view/admin.jsp").include(request,response);
        }
        else if (loginSuccess=="true" && usr!= null && userType=="user"){

...
<body>
	<div class="container">
		...
		<div class="row">
			<div id="addProduct" class="col-sm-12" align="center">
				<button type="submit" class="btn btn-default" onclick="addBTNClick()">Add Book</button>
			</div>
		</div>
				...
				<tbody>
					<c:forEach var="pro" items="${products}">
						<tr>
							...
							<td><a href="editRemove?action=edit&bookID=<c:out value="${pro.bookID}"/>">Edit</a></td>
							<td><a href="editRemove?action=delete&bookID=<c:out value="${pro.bookID}"/>">Delete</a></td>
	...
	<script type="text/javascript" src="<c:url value="/js/ajaxProduct.js"/>"></script>
</body>
</html>